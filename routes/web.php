...
Route::get('/search/quiz/{id}', 'QuizController@search')->name('search.action');
...
Route::get('/storage/user/{id}', 'UserController@picture')->name('user.picture');
  ...
  Route::get('/storage/quiz_category/{id}', 'QuizCategoryController@picture')->name('quizcategory.picture');
